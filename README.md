...
## Project Overview
This project identifies underserved, high-opportunity markets for the deployment of Level 2 Electric Vehicle (EV) charging stations. By analyzing EV registration density relative to existing public charging infrastructure, the objective is to identify low-infrastructure markets with high latent demand, specifically targeting commercial movie theaters, which offer the ideal 2- to 3-hour customer dwell time required for Level 2 charging.
...
The spatial aggregation revealed several high-opportunity, low-infrastructure zones:
* **Orinda (94563):** 3,130 registered EVs sharing 0 public charging stations — a high-opportunity market with no existing public charging.
