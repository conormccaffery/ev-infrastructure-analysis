...
ca_ev_data <- read.csv("datasets/alt_fuel_stations_ca.csv")
head(ca_ev_data)
colnames(ca_ev_data)
...
ev_zip_data <- read.csv("datasets/vehicle-fuel-type-counts-2024.csv")
...
ca_cinemas <- read.delim("datasets/california_cinemas.csv",sep = "\t")
